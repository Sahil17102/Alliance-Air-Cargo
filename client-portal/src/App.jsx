...
function Booking({ addShipment, toast }) {
  ...
  const submit=e=>{
    ...
    addShipment(booking);api.post('/api/bookings',{...form,...booking,extraServices,freightSummary:freight,selectedFlight}).catch(()=>{});localStorage.removeItem('aac_selected_rate');localStorage.removeItem('aac_booking_draft');toast(`Booking confirmed on ${selectedFlight.flightNumber}. AWB ${awb}`);go('shipments')
  }
