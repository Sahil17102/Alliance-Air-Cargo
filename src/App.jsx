      ...
      <div className="container-site relative">
        <div className="grid overflow-hidden rounded-[30px] border border-blue-100 bg-white shadow-[0_28px_80px_rgba(18,53,91,.13)] lg:min-h-[630px] lg:grid-cols-[1.02fr_.98fr]">
          ...
          <div className="relative min-h-[420px] overflow-hidden sm:min-h-[510px] lg:min-h-full">
            <img src="/images/hero-modern-loading.jpg" alt="Air cargo pallets being loaded onto a wide-body aircraft in daylight" className="absolute inset-0 h-full w-full object-cover object-[58%_center]" fetchPriority="high" />
    ...
    <section id="tracking" className="section-pad bg-white">
      <div className="container-site grid items-center gap-12 lg:grid-cols-[.9fr_1.1fr] lg:gap-20">
        <div className="fade-up relative">
          <div className="overflow-hidden rounded-[28px] shadow-soft"><img loading="lazy" src="/images/warehouse-team.jpg" alt="Logistics employees handling shipments in an organized warehouse" className="h-[470px] w-full object-cover" /></div>
  ...
  return (
    <section className="section-pad bg-white">
      <div className="container-site grid overflow-hidden rounded-[28px] bg-mist lg:grid-cols-2">
        ...
        <div className="relative min-h-[370px] overflow-hidden lg:min-h-full"><img loading="lazy" src="/images/cargo-747.jpg" alt="Large cargo aircraft in flight" className="absolute inset-0 h-full w-full object-cover"/><div className="absolute inset-0 bg-gradient-to-t from-navy/55 via-transparent to-transparent"/><div className="absolute bottom-7 left-7 right-7 flex items-center justify-between text-white"><span className="text-xs font-semibold uppercase tracking-wider">Global freighter access</span><span className="rounded-full bg-white/15 px-3 py-1.5 text-[10px] backdrop-blur">Wide-body</span></div></div>
      </div>
    </section>
  )
}
    ...
    <section id="contact" className="section-pad bg-sky">
      <div id="quote" className="container-site grid overflow-hidden rounded-[28px] bg-white shadow-soft lg:grid-cols-[.92fr_1.08fr]">
        <div className="relative min-h-[420px] overflow-hidden p-8 text-white sm:p-12 lg:p-14">
          <img loading="lazy" src="/images/warehouse-ops.jpg" alt="Cargo professionals coordinating warehouse operations" className="absolute inset-0 h-full w-full object-cover"/><div className="absolute inset-0 bg-navy/90"/>
